...
class App extends Component {
    ...
    onSubmit(event){
        ...
        axios.post('https://signupbackend.herokuapp.com/app/signup', registered)
                ...
                <div className="container">
                    <div className="form-div">
                        ...
                        <form onSubmit={(event) => {this.onSubmit(event)}}>
                            <input type='text' placeholder='FullName' onChange={this.changeFullName} value={this.state.fullName} className='form-control form-group' />
